       ...
       (run [_]
         ...
         (let [jtabbed-pane (JTabbedPane.)
           ...
           (doto jtabbed-pane
             ...
             (.addTab "sunflower-seeds" (:sunflower-seeds tabs))
